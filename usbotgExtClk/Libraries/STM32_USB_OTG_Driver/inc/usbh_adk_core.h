...
/** 
	* USBH_ADK_CORE_Exported_Defines
  */ 
	//AOA 1.0
...
typedef struct _ADK_Process
{
  ...
  uint16_t			       inSize;
  uint16_t			       outSize;
  ADK_InitState		     initstate;    //command to android 
  ADK_State            state;        //what device is trying to achieve
...
/** 
  * USBH_ADK_CORE_Exported_FunctionsPrototype
  */
