...
//int TM_I2C_Start(I2C_TypeDef* I2Cx, uint8_t address, uint8_t direction, uint8_t ack) {
...
uint8_t Write_24Cxx(uint16_t Addr, uint8_t Data)
{
...
//		}
		...
		I2C_Send7bitAddress(I2Cx, MEM_DEVICE_WRITE_ADDR, I2C_Direction_Transmitter);
